...
const Home = (props: HomeProps) => {
    ...
    return (
        <main>
            <MainContainer>
                <WalletContainer>
                    <Logo><a href="http://wildwestverse.com/" target="_blank" rel="noopener noreferrer"><img alt=""
                                                                                                          src="logo.png"/></a></Logo>
                    <Wallet>
                        {wallet ?
                ...
                <MintContainer>
                    ...
                    <DesContainer>
                        <Des elevation={2}>
                            <LogoAligner><img src="logo.png" alt=""></img><GoldTitle>WWV Cowgirl</GoldTitle></LogoAligner>
